  ...
  head: () => ({
    meta: [
      { title: "Gestión de Proyectos Empresariales" },
      {
        name: "description",
        content:
          "Consulta y registro de proyectos empresariales. Frontend del parcial de Arquitectura de Software.",
      },
      { property: "og:title", content: "Gestión de Proyectos Empresariales" },
      {
