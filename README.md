<p align="center">
  <img 
    src="https://capsule-render.vercel.app/api?type=waving&height=260&color=0:0f172a,25:1e3a8a,50:2563eb,75:0ea5e9,100:22c55e&text=Parcial%202%20-%20Arquitectura%20de%20Software&fontSize=34&fontColor=ffffff&fontAlignY=38&desc=Sistema%20de%20Gesti%C3%B3n%20de%20Proyectos%20y%20Empleados&descAlignY=55&animation=fadeIn" 
    alt="banner"
  />
</p>
...
<p align="center">
  <a href="https://github.com/spalacioc05/parcial-2-arquisoft-ssjj">
    <img src="https://img.shields.io/badge/GitHub-Repositorio-181717?style=for-the-badge&logo=github" alt="GitHub Repo"/>
  </a>
  <a href="https://parcial-2-arquisoft-ssjj.onrender.com/swagger-ui/index.html">
    <img src="https://img.shields.io/badge/Swagger-OpenAPI-85EA2D?style=for-the-badge&logo=swagger&logoColor=000000" alt="Swagger"/>
  </a>
  <a href="https://parcial-2-arquisoft-ssjj.onrender.com/api/health">
    <img src="https://img.shields.io/badge/Health-UP-22c55e?style=for-the-badge&logo=checkmarx&logoColor=white" alt="Health"/>
  </a>
  <a href="https://parcial-2-arquisoft-ssjj.onrender.com">
    <img src="https://img.shields.io/badge/Backend-Render-46E3B7?style=for-the-badge&logo=render&logoColor=000000" alt="Render"/>
  </a>
...
<p align="center">
  <img src="https://img.shields.io/github/last-commit/spalacioc05/parcial-2-arquisoft-ssjj?style=flat-square&color=2563eb" alt="last commit"/>
  <img src="https://img.shields.io/github/repo-size/spalacioc05/parcial-2-arquisoft-ssjj?style=flat-square&color=0ea5e9" alt="repo size"/>
  <img src="https://img.shields.io/github/languages/top/spalacioc05/parcial-2-arquisoft-ssjj?style=flat-square&color=22c55e" alt="top language"/>
  <img src="https://img.shields.io/badge/Status-Finalizado-success?style=flat-square" alt="status"/>
  <img src="https://img.shields.io/badge/Arquitectura-REST%20%2B%20HATEOAS-blueviolet?style=flat-square" alt="arquitectura"/>
</p>
...
<p>
  ...
  <img src="https://img.shields.io/badge/Spring_HATEOAS-6DB33F?style=for-the-badge&logo=spring&logoColor=white" />
  <img src="https://img.shields.io/badge/Validation-Jakarta-orange?style=for-the-badge" />
  <img src="https://img.shields.io/badge/Swagger-OpenAPI-85EA2D?style=for-the-badge&logo=swagger&logoColor=000000" />
...
<p>
  ...
  <img src="https://img.shields.io/badge/Render-Backend-46E3B7?style=for-the-badge&logo=render&logoColor=000000" />
...
flowchart LR
    U[👤 Usuario / Docente] --> F[🌐 Frontend Web<br/>React + Vite]
    U --> P[🧪 Postman]
    F -->|HTTP + JSON<br/>Accept: application/vnd.parcial.v1+json| B[⚙️ Backend API REST<br/>Spring Boot]
    P -->|Pruebas HTTP| B
    B -->|JDBC / PostgreSQL| DB[(🗄️ Supabase PostgreSQL)]
    B --> S[📘 Swagger / OpenAPI]
    G[📦 GitHub] --> R[☁️ Render]
    G --> V[▲ Vercel]
    R --> B
...
classDiagram
    ...
    Empleado "1" --> "0..*" EmpleadoProyecto
    Proyecto "1" --> "0..*" EmpleadoProyecto
```
...
flowchart TD
    A[🐳 Docker Compose] --> B[Frontend Container<br/>React/Vite]
    A --> C[Backend Container<br/>Spring Boot]
    B -->|HTTP| C
    C -->|JDBC SSL| D[(Supabase PostgreSQL)]
```
...
sequenceDiagram
    ...
    Cliente->>API: GET /api/proyectos?cedula=1001234567\nAccept: application/vnd.parcial.v1+json
    API->>DB: Consulta empleado y proyectos
    DB-->>API: Datos relacionados
    API-->>Cliente: 200 OK + JSON + _links
```
...
```mermaid
flowchart TD
    A[Usuario abre el frontend] --> B[Ingresa cédula]
    B --> C[Frontend llama al backend]
    C --> D[Backend consulta Supabase]
    D --> E[Backend responde JSON + HATEOAS]
    E --> F[Frontend muestra proyectos]

    A --> G[Usuario crea proyecto]
    G --> H[Completa formulario]
    H --> I[Frontend hace POST]
    I --> J[Backend valida y persiste]
    J --> K[Backend responde 201 Created]
...
flowchart LR
    GH[GitHub Repository] --> VE[Vercel<br/>Frontend]
    GH --> RE[Render<br/>Backend]
    VE -->|HTTP/HTTPS| US[Usuario]
    US -->|Usa interfaz web| VE
    VE -->|Consume API| RE
    RE -->|JDBC SSL| SB[(Supabase PostgreSQL)]
```
...
<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&section=footer&height=150&color=0:22c55e,30:0ea5e9,60:2563eb,100:0f172a" />
</p>